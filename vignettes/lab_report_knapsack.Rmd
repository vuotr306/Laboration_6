...
```
As the output shows, it takes lesser then 2 times for greedy approach to run the code for one million objects compare to brute force approach to run 16 objects.   
