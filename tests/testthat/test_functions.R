...
test_that("functions return the same results.", {
  ...
  expect_equal(unname(knapsack_dynamic(x = knapsack_objects[1:8,], W = 3500)) , brute_force_knapsack_C(x = as.matrix(knapsack_objects[1:8,]), W = 3500))
  expect_equal(unname(knapsack_dynamic(x = knapsack_objects[1:12,], W = 3500)) , brute_force_knapsack_C(x = as.matrix(knapsack_objects[1:12,]), W = 3500))
  expect_equal(unname(knapsack_dynamic(x = knapsack_objects[1:8,], W = 2000)) , brute_force_knapsack_C(x = as.matrix(knapsack_objects[1:8,]), W = 2000))
  expect_equal(unname(knapsack_dynamic(x = knapsack_objects[1:12,], W = 2000)) , brute_force_knapsack_C(x = as.matrix(knapsack_objects[1:12,]), W = 2000))
