...
When writing this, the dynamic programming algorithm is about 10 ????????? times faster than the brute force algorighm. Another simulation, with 500 objects took around ???????????? seconds to perform.
